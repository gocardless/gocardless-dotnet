...
namespace GoCardless.Tests
{
    public class BankAccountHolderVerificationsCreateCodeSampleTest
    {
        ...
        public async Task CreateCodeSampleExecutesWithoutError()
        {
            ...
            try
            {
                var verificationLinks =
                    new GoCardless.Services.BankAccountHolderVerificationCreateRequest.BankAccountHolderVerificationLinks
                    {
                        BankAccount = "BA123",
                    };
                ...
                var resp = await client.BankAccountHolderVerifications.CreateAsync(
                    new GoCardless.Services.BankAccountHolderVerificationCreateRequest()
                    {
                        Type = GoCardless
                            .Services
                            .BankAccountHolderVerificationCreateRequest
                            .BankAccountHolderVerificationType
                            .ConfirmationOfPayee,
