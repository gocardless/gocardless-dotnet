        ...
        public async Task CreateCodeSampleExecutesWithoutError()
        {
            ...
            try
            {
                var prefilledCustomer =
                    new GoCardless.Services.BillingRequestFlowCreateRequest.BillingRequestFlowPrefilledCustomer()
                    {
                ...
                var resp = await client.BillingRequestFlows.CreateAsync(
                    new GoCardless.Services.BillingRequestFlowCreateRequest()
                    {
                        ...
                        Links =
                            new GoCardless.Services.BillingRequestFlowCreateRequest.BillingRequestFlowLinks
                            {
                ...
                GoCardless.Resources.BillingRequestFlow billingRequestFlow =
                    resp.BillingRequestFlow;
            }
            finally
            {
