        ...
        public async Task ListCodeSampleExecutesWithoutError()
        {
            ...
            try
            {
                var verificationDetailListRequest =
                    new GoCardless.Services.VerificationDetailListRequest() { Creditor = "CR123" };

                var verificationDetailListResponse = client.VerificationDetails.All(
                    verificationDetailListRequest
                );
