...
namespace GoCardless.Tests
{
    public class ScenarioSimulatorsRunCodeSampleTest
    {
        ...
        [Test]
        public async Task RunCodeSampleExecutesWithoutError()
        {
            ...
            try
            {
                ...
                {
                    Links =
                        new GoCardless.Services.ScenarioSimulatorRunRequest.ScenarioSimulatorLinks()
                        {
                            Resource = "PM123",
                        },
                };

                var response = await client.ScenarioSimulators.RunAsync(
                    "payment_failed",
                    simulateRequest
                );
            }
