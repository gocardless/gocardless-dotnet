    ...
    public class BankDetailsLookupsCreateCodeSampleTest
    {
        ...
        public async Task CreateCodeSampleExecutesWithoutError()
        {
            ...
            try
            {
                ...
                var bankDetailsResponse = await client.BankDetailsLookups.CreateAsync(
                    bankDetailsRequest
                );
                GoCardless.Resources.BankDetailsLookup bankDetails =
                    bankDetailsResponse.BankDetailsLookup;
            }
            finally
            {
