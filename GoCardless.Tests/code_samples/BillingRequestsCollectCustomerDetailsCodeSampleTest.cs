...
namespace GoCardless.Tests
{
    public class BillingRequestsCollectCustomerDetailsCodeSampleTest
    {
        ...
        [Test]
        public async Task CollectCustomerDetailsCodeSampleExecutesWithoutError()
        {
            ...
            {
                var customer =
                    new GoCardless.Services.BillingRequestCollectCustomerDetailsRequest.BillingRequestCustomer
                    {
                ...
                var customerBillingDetail =
                    new GoCardless.Services.BillingRequestCollectCustomerDetailsRequest.BillingRequestCustomerBillingDetail
                    {
                        AddressLine1 = "1 Somewhere Lane",
                    };

                var resp = await client.BillingRequests.CollectCustomerDetailsAsync(
                    "BR123",
