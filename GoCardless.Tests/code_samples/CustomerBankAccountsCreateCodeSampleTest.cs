        ...
        public async Task CreateCodeSampleExecutesWithoutError()
        {
            ...
            try
            {
                var customerBankAccountRequest =
                    new GoCardless.Services.CustomerBankAccountCreateRequest()
                    {
                        ...
                        CountryCode = "GB",
                        Links =
                            new GoCardless.Services.CustomerBankAccountCreateRequest.CustomerBankAccountLinks()
                            {
                                Customer = "CU0123",
                            },
                    };

                var customerBankAccountResponse = await client.CustomerBankAccounts.CreateAsync(
