...
namespace GoCardless.Tests
{
    public class LogosCreateForCreditorCodeSampleTest
    {
        ...
        public async Task CreateForCreditorCodeSampleExecutesWithoutError()
        {
            ...
            try
            {
                var logoCreateForCreditorRequest =
                    new GoCardless.Services.LogoCreateForCreditorRequest()
                    {
                        Image =
                ...
                var logoCreateForCreditorResponse = await client.Logos.CreateForCreditorAsync(
