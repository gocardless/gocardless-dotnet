...
namespace GoCardless.Tests
{
    public class FundsAvailabilitiesCheckCodeSampleTest
    {
        ...
        [Test]
        public async Task CheckCodeSampleExecutesWithoutError()
        {
            ...
            try
            {
                var request = new GoCardless.Services.FundsAvailabilityCheckRequest()
                {
                    Amount = "1000",
                };

                var resp = await client.FundsAvailabilities.CheckAsync("MD123", request);
            }
            finally
            {
