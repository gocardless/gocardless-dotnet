...
namespace GoCardless.Resources
{
    ...
    {
        /// <summary>
        ///  When we send a creditor `new_payout_currency_added` webhook, we
    ...
    public class EventLinks
    {
        /// <summary>
        ///  ID of a [bank
        ///  authorisation](#billing-requests-bank-authorisations).
        /// </summary>
        ...
        /// <summary>
        ///  This is only included for mandate transfer events, when it is the
        ///  ID of the [customer bank
        ...
        /// <summary>
        ///  This is only included for mandate replaced events, when it is the
        ///  ID of the new [mandate](#core-endpoints-mandates) that replaces the
        ///  existing mandate.
        /// </summary>
        ...
        ///  [OAuth app](#appendix-oauth), this is the ID of the account to
        ///  which it belongs.
        /// </summary>
