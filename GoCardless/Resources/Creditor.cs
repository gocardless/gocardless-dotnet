...
namespace GoCardless.Resources
{
    ...
    public class Creditor
    {
        ...
        /// 
        /// The support address,
        /// `phone_number` and `email` fields are for customers to contact the
        /// merchant for support purposes. They must be displayed on the payment
        ...
        /// <ul>
        /// <li>`successful`: The
        /// creditor's account is fully verified, and they can receive payouts.
        /// Once a creditor has been successfully verified, they may in the
        /// future require further verification - for example, if they change
        /// their payout bank account, we will have to check that they own the
        /// new bank account before they can receive payouts again.</li>
       
        /// /// <li>`in_review`: The creditor has provided all of the
    ...
    public class CreditorSchemeIdentifier
    {
        ...
        /// 
        /// By default,
        /// GoCardless sends these notifications automatically. Please see our
        /// [compliance requirements](#appendix-compliance-requirements) for
        /// more details.
        /// </summary>
    ...
    public enum CreditorVerificationStatus {
        ...
        ///      /// <ul>
        /// <li>`successful`: The creditor's account is fully verified,
        /// and they can receive payouts. Once a creditor has been successfully verified, they may
        /// in the future require further verification - for example, if they change their payout
        /// bank account, we will have to check that they own the new bank account before they can
        /// receive payouts again.</li>
        /// <li>`in_review`: The creditor has provided all
        /// of the information currently requested, and it is awaiting review by GoCardless before
        /// they can be verified and receive payouts.</li>
        /// <li>`action_required`: The
        /// creditor needs to provide further information to verify their account so they can
        /// receive payouts, and should visit the verification flow.</li>
        /// </ul>
        /// </summary>
