...
namespace GoCardless.Resources
{
    ...
    public class Creditor
    {
        ...
        ///  exchange). Currently "AUD", "CAD", "DKK", "EUR", "GBP", "NZD",
        ///  "SEK" and "USD" are supported. Present only if payouts will be (or
        ...
        /// <summary>
        ///  Boolean value indicating whether the organisation is responsible
        ///  for sending all customer notifications (note this is separate from
        ...
        /// <summary>
        ///  An array of the scheme identifiers this creditor can create
        ///  mandates against.
        ///
        ///  The support address, `phone_number` and `email` fields are for
        ///  customers to contact the merchant for support purposes. They must
        ///  be displayed on the payment page, please see our [compliance
        ...
        ///  One of:
        ///  <ul>
        ///  <li>`successful`: The creditor's account is fully verified, and
        ...
        ///  information to verify their account so they can receive payouts,
    ...
    public class CreditorSchemeIdentifier
    {
        ...
        ///  identifiers will be applied to a creditor and used against
        ///  payments.
        /// </summary>
        [JsonProperty("status")]
