...
namespace GoCardless.Resources
{
    ...
    public class BillingRequestWithAction
    {
        ...
        /// <summary>
        ///   Billing Requests help create resources that require input or
        ///  action from a customer. An example of required input might be
        ///  additional customer billing details, while an action would be
        ///  asking a customer to authorise a payment using their mobile banking
        ///  app.
        ///
        ///  See [Billing Requests:
        ///  Overview](https://developer.gocardless.com/getting-started/billing-requests/overview/)
        ///  for how-to's, explanations and tutorials. <p
        ///  class="notice"><strong>Important</strong>: All properties
    ...
    public class BillingRequestWithActionBankAuthorisations
    {
        ...
        /// <summary>
        ///  Timestamp when the url will expire. Each authorisation url
        ///  currently lasts for 15 minutes, but this can vary by bank.
        /// </summary>
        ...
        ///  BillingRequestWithActionBankAuthorisations.
        /// </summary>
        [JsonProperty("links")]
        ...
        ///  This QR code can be used as an alternative to providing the `url`
        ///  to the payer to allow them to authorise with their mobile devices.
        /// </summary>
    ...
    ///  resource.
    ///
    ///  List of actions that can be performed before this billing request can
    ///  be fulfilled.
    /// </summary>
    public class BillingRequestWithActionBillingRequestAction
    {
        ...
        /// <summary>
        ///  Describes whether we inferred the institution from the provided
        ///  bank account details. One of:
    ...
    public class BillingRequestWithActionBillingRequestsLinks
    {
        ...
        /// <summary>
        ///  ID of the customer billing detail that will be used for this
        ///  request
        /// </summary>
        [JsonProperty("customer_billing_detail")]
    ...
    public class BillingRequestWithActionBillingRequestsMandateRequestConstraints
    {
        ...
        ///  how payments are calculated. _Note:_ This is only supported for ACH
        ///  and PAD schemes.
        ///
        /// </summary>
    ...
    ///  Monthly it will expire on the same day of the next month, or yearly the same day of the
    ///  next year.
    ///
    /// </summary>
    [JsonConverter(typeof(GcStringEnumConverter), (int)Unknown)]
    ...
    public class BillingRequestWithActionBillingRequestsPaymentRequest
    {
        ...
        ///  paid to the partner integration which created the billing request,
