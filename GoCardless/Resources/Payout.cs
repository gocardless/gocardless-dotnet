...
namespace GoCardless.Resources
{
    ...
    public class Payout
    {
        ...
        ///  One of:
        ///  <ul>
        ///    <li>`yyyy-mm-dd`: the payout has been paid and is due to arrive
        ///  in the creditor's bank
        ...
        /// <summary>
        ///  Fees that have already been deducted from the payout amount in
        ///  minor unit (e.g. pence in GBP, cents in EUR), inclusive of tax if
        ///  applicable.
        ///  <br />
        ...
        ///  <br />
        ///  This field is calculated as `(GoCardless fees + app fees +
        ///  surcharge fees) - (refunded fees)`
        ///  <br />
        ...
        ///  your tax jurisdiction. Currently “EUR”, “GBP”, for French or
        ///  British merchants, this will be `null` if tax is not applicable
        ///  <em>beta</em>
        /// </summary>
