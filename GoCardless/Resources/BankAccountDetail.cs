...
namespace GoCardless.Resources
{
    ...
    public class BankAccountDetail
    {
        ...
        ///
        /// <ul>
        /// <li><c>alg</c>: the asymmetric encryption type used to encrypt
        /// symmetric key, e.g: <c>RSA-OAEP</c>.</li>
        /// <li><c>enc</c>: the content encryption type, e.g:
        /// <c>A256GCM</c>.</li>
        /// <li><c>kid</c>: the ID of an RSA-2048 public key, from your JWKS,
