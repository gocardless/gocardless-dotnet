...
namespace GoCardless.Resources
{
    ...
    public class ScenarioSimulator
    {
        ...
        ///  the creditor must provide further information to GoCardless in
        ...
        ///  `confirmed`. It must start in the `pending_submission` state, and
        ///  its mandate must be in the `activated` state (unless it is a
        ///  payment for ACH, BECS, BECS_NZ or SEPA, in which cases the mandate
        ///  may be `pending_submission`, since their mandates are submitted
        ///  with their first payment).</li>
        ///  <li>`payment_paid_out`: Transitions a payment through to
        ///  `paid_out`, having been collected successfully and paid out to you.
        ///  It must start in the `pending_submission` state, and its mandate
        ///  must be in the `activated` state (unless it is a payment for ACH,
        ...
        ///  transitioned to `charged_back` after it is paid out, having been
        ...
        ///  customer signatures on the mandate. All payments associated with
        ///  the mandate will be transitioned to `pending_submission`. All
        ...
        ///  and SEPA mandates, which support customer signatures on the
        ///  mandate. All payments associated with the mandate will be
        ///  transitioned to `pending_submission`. All subscriptions associated
        ...
        ///  `pending_submission` or `submitted` states. Not compatible with
        ///  SEPA mandates, which are submitted with their first payment.</li>
        ...
        ///  successfully and then moved to a new bank account due. It must
        ...
        ///  `suspended_by_payer`, as if payer has suspended the mandate after
        ///  it has been setup successfully. It must start in the `activated`
        ...
        ///  state.</li>
        ///  <li>`refund_returned`: Transitions a refund to `refund_returned`.
        ...
        ///  and then fulfils it. The billing request must be in the `pending`
        ///  state, with all actions completed except for `bank_authorisation`.
        ...
        ///  <li>`billing_request_fulfilled_and_payment_paid_out`: Authorises
        ///  the billing request, fulfils it, and moves the associated payment
        ///  to `paid_out`. The billing request must be in the `pending` state,
