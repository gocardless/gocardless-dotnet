...
namespace GoCardless.Resources
{
    ...
    public class ScenarioSimulator
    {
        ...
        /// `verification status` to `action required`, meaning that the
        /// creditor must provide further information to GoCardless in order to
        /// verify their account to receive payouts.
        ...
        /// their account, and is now awaiting review.
        ...
        /// since their mandates are submitted with their first payment).
        /// - `payment_failed`: Transitions a payment through to `failed`. It
        ...
        /// start in the `pending_submission` state. Not compatible with ACH,
        /// BECS, BECS_NZ and SEPA mandates, which are submitted and activated
        ...
        /// `pending_customer_approval` state. Compatible only with Bacs and
        /// SEPA mandates, which support customer signatures on the mandate. All
        ...
        /// in the `pending_submission` state. Only compatible with Bacs and
        /// SEPA mandates.
        ...
        /// Only compatible with PAY_TO mandates.
