...
namespace GoCardless.Resources
{
    ...
    public class BillingRequestFlow
    {
        ...
        ///  the flow (true by default). Disabling the auto_fulfil is not
        ///  allowed currently.
        /// </summary>
        ...
        /// <summary>
        ///  Timestamp when the flow will expire. Each flow currently lasts for
        ///  7 days.
        /// </summary>
        ...
        ///  manually within the flow. Note that this only applies to the
        ///  mandate only flows - currency/scheme can never be changed when
        ///  there is a specified subscription or payment.
        /// </summary>
        ...
        /// <summary>
        ///  URL that the payer can be redirected to after completing the
        ///  request flow.
        /// </summary>
        ...
        ///  For successful flow, the button will take the payer back the
        ///  billing request flow where they will see the success screen. For
        ///  failure, button will take the payer to url being provided against
        ///  exit_uri field.
        /// </summary>
    ...
    ///
    ///  Bank account information used to prefill the payment page so your
    ///  customer doesn't have to re-type details you already hold about them.
    ///  It will be stored unvalidated and the customer will be able to review
    ///  and amend it before completing the form.
    /// </summary>
