...
namespace GoCardless.Resources
{
    ...
    public class PayoutItem
    {
        ...
        /// merchants.
        /// - `app_fee` (credit/debit): The optional fees that a partner may
        /// have taken for a payment. In the case of a payment failure or
        /// chargeback, these will appear as credits.
        /// - `revenue_share` (credit/debit): A share of the fees that
        ...
        /// credits.
        /// - `surcharge_fee` (credit/debit): GoCardless deducted a surcharge
        ...
        /// include taxes if applicable for merchants.
        ///
        /// </summary>
        [JsonProperty("type")]
