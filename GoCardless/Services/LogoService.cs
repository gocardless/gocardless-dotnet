...
namespace GoCardless.Services
{
    ...
    ///
    ///  Logos are image uploads that, when associated with a creditor, are
    ///  shown on the [billing request
    ...
    public class LogoService
    {
        ...
        /// <summary>
        ///  Creates a new logo associated with a creditor. If a creditor
        ///  already has a logo, this will update the existing logo linked to
        ///  the creditor.
        ///
