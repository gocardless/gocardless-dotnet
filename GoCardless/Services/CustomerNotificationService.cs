...
namespace GoCardless.Services
{
    ...
    public class CustomerNotificationService
    {
        ...
        public Task<CustomerNotificationResponse> HandleAsync(
            string identity,
            CustomerNotificationHandleRequest request = null,
        ...
        )
        {
            ...
            return _goCardlessClient.ExecuteAsync<CustomerNotificationResponse>(
                "POST",
