...
namespace GoCardless.Services
{
    ...
    public class BillingRequestService
    {
        ...
        ///  action, this endpoint can be used to collect the details in order
        ///  to
        ///  complete it.
        ///
        ...
        /// <summary>
        ///  If a billing request is ready to be fulfilled, call this endpoint
        ///  to cause
        ...
        /// <summary>
        ///  Creates an Institution object and attaches it to the Billing
        ///  Request
        /// </summary>
        ///  <param name="identity">Unique identifier, beginning with "BRQ".</param>
    ...
    public class BillingRequestCreateRequest : IHasIdempotencyKey
    {
        ...
        {
            /// <summary>
            ///  The amount to be deducted from each payment as an app fee, to
            ///  be paid to the partner integration which created the
            ///  subscription, in the lowest denomination for the currency (e.g.
            ...
            public class BillingRequestInstalmentsWithSchedule
            {
                ...
                /// <summary>
                ///  Number of `interval_units` between charge dates. Must be
                ///  greater than or
                ///  equal to `1`.
                ///
                /// </summary>
                ...
                ///  `day_of_month` are provided, this will be set to the date of
                ///  the first payment. If created without `month` or `day_of_month`
            ...
            /// <summary>
            ///  Name of the instalment schedule, up to 100 chars. This name
            ///  will also be
            ...
            /// <summary>
            ///  An optional payment reference. This will be set as the
            ///  reference on each payment
            ...
            ///  intelligent retries, Success+ needs to be enabled in
            ///  [GoCardless
        ...
        public class BillingRequestMandateRequest
        {
            ...
            public class BillingRequestConstraints
            {
                ...
                ///  about how payments are calculated. _Note:_ This is only
                ///  supported for ACH and PAD schemes.
                ///
                /// </summary>
                ...
                public class BillingRequestPeriodicLimits
                {
                    ...
                    /// <summary>
                    ///  The maximum total amount that can be charged for all payments
                    ///  in this periodic limit.
                    ///  Required for VRP.
                    ///
                    /// </summary>
            ...
            ///  This will be displayed to the payer when authorising the
            ///  billing request.
            ///
            /// </summary>
            [JsonProperty("description")]
            ...
            ///  and payed out.
            ///  - `direct` will be a direct transfer from the payer's account
            ...
            ///  "becs", "becs_nz", "betalingsservice", "faster_payments",
            ///  "pad", "pay_to" and "sepa_core" are supported. Optional for
            ///  mandate only requests - if left blank, the payer will be able
            ///  to select the currency/scheme to pay with from a list of your
            ///  available schemes.
            /// </summary>
            [JsonProperty("scheme")]
            ...
            ///  verification preference. It uses GoCardless payment
            ///  intelligence solution to determine if a payer is fraudulent or
            ///  not. The verification mechanism is based on the response and
            ///  the payer may be asked to verify themselves. If the feature is
            ///  not available, `recommended` behaves like `minimum`.
            ///
            ///  If you never wish to take advantage of our reduced risk
            ///  products and Verified Mandates as they are released in new
            ///  schemes, please use the `minimum` verification preference.
            ///
            ...
            ///  and Verified Mandates as they are released in new schemes, please
            ///  use the `minimum` verification preference.
            ///
            ///  See [Billing Requests: Creating Verified
            ///  Mandates](https://developer.gocardless.com/getting-started/billing-requests/verified-mandates/)
            ///  for more information.
        ...
        public class BillingRequestPaymentRequest
        {
            ...
            ///  request, in the lowest denomination for the currency (e.g.
            ///  pence in GBP, cents in EUR).
            /// </summary>
            [JsonProperty("app_fee")]
            public int? AppFee { get; set; }
            ...
            ///  available for payments on the PayTo scheme or payments using
            ///  the Direct Funds settlement model on the Faster Payments
            ///  scheme.
            ///
            /// </summary>
            [JsonProperty("reference")]
            ...
            ///  countries, `sepa_credit_transfer` is used as the default.
            ///  Please be aware that `sepa_instant_credit_transfer` may incur
        ...
        public class BillingRequestSubscriptionRequest
        {
            ...
            ///  When left blank and `month` or `day_of_month` are provided,
            ///  this will be set to the date of the first payment.
            ///  If created without `month` or `day_of_month` this will be set
    ...
    public class BillingRequestCollectCustomerDetailsRequest
    {
        ...
        public class BillingRequestCustomerBillingDetail
        {
            ...
            ///  belongs (i.e. as a result of their completion of a mandate
