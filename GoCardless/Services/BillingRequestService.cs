...
namespace GoCardless.Services
{
    ...
    public class BillingRequestService
    {
        ...
        /// <summary>
        /// This endpoint allows you to create a billing request and complete
        /// any required actions in a single request.
        /// </summary>
        /// <param name="request">An optional `BillingRequestCreateWithActionsRequest` representing the body for this create_with_actions request.</param>
        /// <param name="customiseRequestMessage">An optional `RequestSettings` allowing you to configure the request</param>
        /// <returns>A single billing request resource</returns>
        public Task<BillingRequestResponse> CreateWithActionsAsync(BillingRequestCreateWithActionsRequest request = null, RequestSettings customiseRequestMessage = null)
        {
            request = request ?? new BillingRequestCreateWithActionsRequest();

            var urlParams = new List<KeyValuePair<string, object>>
            {};

            return _goCardlessClient.ExecuteAsync<BillingRequestResponse>("POST", "/billing_requests/create_with_actions", urlParams, request, id => GetAsync(id, null, customiseRequestMessage), "billing_requests", customiseRequestMessage);
        }
    }
    ...
    /// </summary>
    public class BillingRequestCreateWithActionsRequest : IHasIdempotencyKey
    {

        /// <summary>
        /// Supports the same shape of the request payload as individual action
        /// routes.
        /// </summary>
        [JsonProperty("actions")]
        public BillingRequestActions Actions { get; set; }
        /// <summary>
        /// Supports the same shape of the request payload as individual action
        /// routes.
        /// </summary>
        public class BillingRequestActions
        {
            ...
            /// payment
                ...
                /// <summary>
                            /// Supports the same structure as the collect_bank_account
            /// endpoint.
                /// </summary>
                [JsonProperty("collect_bank_account")]
                public BillingRequestCollectBankAccount CollectBankAccount { get; set; }
        /// <summary>
        /// Supports the same structure as the collect_bank_account endpoint.
        /// </summary>
        public class BillingRequestCollectBankAccount
        {
        ...
        public enum BillingRequestAccountType
        {
            ...
            /// company number, that can be used to make and accept payments.
                ...
                /// <summary>
                            /// Supports the same structure as the collect_customer_details
            /// endpoint.
                /// </summary>
                [JsonProperty("collect_customer_details")]
                public BillingRequestCollectCustomerDetails CollectCustomerDetails { get; set; }
        /// <summary>
        /// Supports the same structure as the collect_customer_details
        /// endpoint.
        /// </summary>
        public class BillingRequestCollectCustomerDetails
        {
        ...
        public class BillingRequestCustomerBillingDetail
        {
            ...
            /// once it has been set.
                ...
                /// <summary>
                            /// By default, we will auto confirm the payer details when this
            /// endpoint is used for relevant billing requests. You can skip
            /// this parameter entirely if you don't need to specify dual
            /// signatory or metadata. The assumption is that you have already
            /// adhered to your compliance requirements of confirming these
            /// details with the payer before calling this endpoint. Please
            /// refer to the confirm_payer_details endpoint for more
            /// information.
                /// </summary>
                [JsonProperty("confirm_payer_details")]
                public BillingRequestConfirmPayerDetails ConfirmPayerDetails { get; set; }
        /// <summary>
        /// By default, we will auto confirm the payer details when this
        /// endpoint is used for relevant billing requests. You can skip this
        /// parameter entirely if you don't need to specify dual signatory or
        /// metadata. The assumption is that you have already adhered to your
        /// compliance requirements of confirming these details with the payer
        /// before calling this endpoint. Please refer to the
        /// confirm_payer_details endpoint for more information.
        /// </summary>
        public class BillingRequestConfirmPayerDetails
        {
            ...
            /// flow can only be completed using GoCardless branded pages.
                ...
                /// <summary>
                            /// For instant payments, pass this boolean in order to create a
            /// bank authorisation link that payer's can use to authorise the
            /// payment. By default this is considered false.
                /// </summary>
                ...
                public BillingRequestSelectInstitution SelectInstitution { get; set; }
        /// <summary>
        /// Supports the same structure as the select_institution endpoint.
        /// </summary>
        public class BillingRequestSelectInstitution
        {
        ...
        /// <summary>
        /// Supports all the same params as the standalone CREATE billing
        /// request endpoint.
        /// </summary>
        [JsonProperty("mandate_request")]
        public BillingRequestMandateRequest MandateRequest { get; set; }
