...
namespace GoCardless.Services
{
    ...
    public class OutboundPaymentService
    {
        ...
        public Task<OutboundPaymentResponse> CreateAsync(
            OutboundPaymentCreateRequest request = null,
        ...
        /// <param name="customiseRequestMessage">An optional `RequestSettings` allowing you to configure the request</param>
        /// <returns>A single outbound payment resource</returns>
        public Task<OutboundPaymentResponse> WithdrawAsync(
            OutboundPaymentWithdrawRequest request = null,
            RequestSettings customiseRequestMessage = null
        )
        {
        ...
        /// <param name="customiseRequestMessage">An optional `RequestSettings` allowing you to configure the request</param>
        /// <returns>A single outbound payment resource</returns>
        public Task<OutboundPaymentResponse> CancelAsync(
            string identity,
            OutboundPaymentCancelRequest request = null,
            RequestSettings customiseRequestMessage = null
        )
        {
        ...
        /// <param name="customiseRequestMessage">An optional `RequestSettings` allowing you to configure the request</param>
        /// <returns>A single outbound payment resource</returns>
        public Task<OutboundPaymentResponse> ApproveAsync(
            string identity,
            OutboundPaymentApproveRequest request = null,
            RequestSettings customiseRequestMessage = null
        )
        {
        ...
        /// <param name="customiseRequestMessage">An optional `RequestSettings` allowing you to configure the request</param>
        /// <returns>A single outbound payment resource</returns>
        public Task<OutboundPaymentResponse> GetAsync(
            string identity,
            OutboundPaymentGetRequest request = null,
            RequestSettings customiseRequestMessage = null
        )
        {
        ...
        public Task<OutboundPaymentListResponse> ListAsync(
            OutboundPaymentListRequest request = null,
            RequestSettings customiseRequestMessage = null
        )
        {
            ...
            return _goCardlessClient.ExecuteAsync<OutboundPaymentListResponse>(
                "GET",
                "/outbound_payments",
                urlParams,
                request,
        ...
        /// </summary>
        public IEnumerable<OutboundPayment> All(
            OutboundPaymentListRequest request = null,
            RequestSettings customiseRequestMessage = null
        )
        {
        ...
        /// This acts like the #list method, but paginates for you automatically.
        /// </summary>
        public IEnumerable<Task<IReadOnlyList<OutboundPayment>>> AllAsync(
            OutboundPaymentListRequest request = null,
            RequestSettings customiseRequestMessage = null
        )
        {
        ...
        /// <param name="customiseRequestMessage">An optional `RequestSettings` allowing you to configure the request</param>
        /// <returns>A single outbound payment resource</returns>
        public Task<OutboundPaymentResponse> UpdateAsync(
            string identity,
            OutboundPaymentUpdateRequest request = null,
            RequestSettings customiseRequestMessage = null
        )
        {
