...
namespace GoCardless.Services
{
    ...
    public class BankDetailsLookupService
    {
        ...
        ///
        /// For UK or Eurozone-based bank accounts, where an account holder name
        /// is provided
        /// (and an account number, a sort code or an IBAN are already present),
        /// we verify that
        /// the account holder name and bank account number match the details
        /// held by the relevant bank.
        /// If there is no match, the endpoint will return a 422 - validation
        /// error on account_holder_name:
