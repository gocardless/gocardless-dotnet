...
namespace GoCardless.Services
{
    ...
    public class InstitutionService
    {
        ...
        public Task<InstitutionListResponse> ListAsync(
            InstitutionListRequest request = null,
        ...
        )
        {
            ...
            return _goCardlessClient.ExecuteAsync<InstitutionListResponse>(
                "GET",
                "/institutions",
                urlParams,
                request,
        ...
        /// <param name="customiseRequestMessage">An optional `RequestSettings` allowing you to configure the request</param>
        /// <returns>A set of institution resources</returns>
        public Task<InstitutionListResponse> ListForBillingRequestAsync(
            string identity,
            InstitutionListForBillingRequestRequest request = null,
            RequestSettings customiseRequestMessage = null
        )
        {
    ...
    public class InstitutionListRequest
    {
        ...
        ///  identifies both the bank and the specific branch where an account
        ///  is held, eg. '601234'.
        /// </summary>
        ...
        /// <summary>
        ///  The feature that institutions support. The available options
        ///  include `pis`, and `vrp_sweeping`. If nothing is provided,
        ...
        ///  `sepa_instant_credit_transfer`. If nothing is provided,
