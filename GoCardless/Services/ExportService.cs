...
namespace GoCardless.Services
{
    ...
    public class ExportService
    {
        ...
        public Task<ExportResponse> GetAsync(
            string identity,
            ExportGetRequest request = null,
        ...
        )
        {
            ...
            return _goCardlessClient.ExecuteAsync<ExportResponse>(
                "GET",
                "/exports/:identity",
                urlParams,
                request,
        ...
        public Task<ExportListResponse> ListAsync(
            ExportListRequest request = null,
            RequestSettings customiseRequestMessage = null
        )
        {
            ...
            return _goCardlessClient.ExecuteAsync<ExportListResponse>(
                "GET",
                "/exports",
                urlParams,
                request,
        ...
        /// This acts like the #list method, but paginates for you automatically.
        /// </summary>
        public IEnumerable<Task<IReadOnlyList<Export>>> AllAsync(
            ExportListRequest request = null,
            RequestSettings customiseRequestMessage = null
        )
        {
