...
namespace GoCardless.Services
{
    ...
    public class RedirectFlowService
    {
        ...
        /// <summary>
        ///  This creates a [customer](#core-endpoints-customers), [customer
        ...
        ///  already completed this flow. It will return a `bad_request` error
        ///  if the `session_token` differs to the one supplied when the
    ...
    public class RedirectFlowCreateRequest : IHasIdempotencyKey
    {
        ...
        public class RedirectFlowLinks
        {
            ...
            ///  will be created. The `name` of the creditor will be displayed
            ///  on the payment page. Required if your account manages multiple
            ///  creditors.
            /// </summary>
        ...
        ///  them. It will be stored unvalidated and the customer will be able
        ...
        public class RedirectFlowPrefilledCustomer
        {
            ...
            /// <summary>
            ///  Customer's company name. Company name should only be provided
            ///  if `given_name` and `family_name` are null.
            /// </summary>
