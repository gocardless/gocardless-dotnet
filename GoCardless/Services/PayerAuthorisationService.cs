...
namespace GoCardless.Services
{
    ...
    ///  PayerAuthorisation API enables the integrators to build their own
    ...
    ///  created
    ///
    ///  After the Payer Authorisation is confirmed, resources will eventually
    ///  be created as it's an asynchronous process.
    ///
    ...
    ///    We return the list of incomplete data in the `incomplete_fields`
    ///  along with the resources in the body of the response.
    ///    The bank account details(account_number, bank_code & branch_code)
    ///  must be sent together rather than splitting across different request
    ///  for both `create` and `update` endpoints.
    ///    <br><br>
    ...
    public class PayerAuthorisationService
    {
        ...
        public Task<PayerAuthorisationResponse> GetAsync(
            string identity,
            PayerAuthorisationGetRequest request = null,
        ...
        )
        {
            ...
            return _goCardlessClient.ExecuteAsync<PayerAuthorisationResponse>(
                "GET",
        ...
        /// <summary>
        ///  Creates a Payer Authorisation. The resource is saved to the
        ///  database even if incomplete. An empty array of incomplete_fields
        ///  means that the resource is valid. The ID of the resource is used
        ///  for the other actions. This endpoint has been designed this way so
        ///  you do not need to save any payer data on your servers or the
        ///  browser while still being able to implement a progressive solution,
        ...
        /// <param name="customiseRequestMessage">An optional `RequestSettings` allowing you to configure the request</param>
        /// <returns>A single payer authorisation resource</returns>
        public Task<PayerAuthorisationResponse> CreateAsync(
            PayerAuthorisationCreateRequest request = null,
            RequestSettings customiseRequestMessage = null
        )
        {
        ...
        ///  has been designed this way so you do not need to save any payer
        ///  data on your servers or the browser while still being able to
        ///  implement a progressive solution, such a multi-step form. <p
        ///  class="notice"> Note that in order to update the `metadata`
        ///  attribute values it must be sent completely as it overrides the
        ...
        /// <param name="customiseRequestMessage">An optional `RequestSettings` allowing you to configure the request</param>
        /// <returns>A single payer authorisation resource</returns>
        public Task<PayerAuthorisationResponse> UpdateAsync(
            string identity,
            PayerAuthorisationUpdateRequest request = null,
            RequestSettings customiseRequestMessage = null
        )
        {
        ...
        /// <param name="customiseRequestMessage">An optional `RequestSettings` allowing you to configure the request</param>
        /// <returns>A single payer authorisation resource</returns>
        public Task<PayerAuthorisationResponse> SubmitAsync(
            string identity,
            PayerAuthorisationSubmitRequest request = null,
            RequestSettings customiseRequestMessage = null
        )
        {
        ...
        ///  after they go through our flow or make them go through the
        ///  necessary verification mechanism (upcoming feature).
        ///  </p>
        /// </summary>
        ///  <param name="identity">Unique identifier, beginning with "PA".</param>
        ...
        /// <param name="customiseRequestMessage">An optional `RequestSettings` allowing you to configure the request</param>
        /// <returns>A single payer authorisation resource</returns>
        public Task<PayerAuthorisationResponse> ConfirmAsync(
            string identity,
            PayerAuthorisationConfirmRequest request = null,
            RequestSettings customiseRequestMessage = null
        )
        {
