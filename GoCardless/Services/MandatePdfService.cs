...
namespace GoCardless.Services
{
    ...
    public class MandatePdfCreateRequest
    {
        ...
        /// <summary>
        ///  SWIFT BIC. Will be derived automatically if a valid `iban` or
        ///  [local details](#appendix-local-bank-details) are provided.
        /// </summary>
        [JsonProperty("bic")]
        ...
        ///  the customer. Should only be supplied for Betalingsservice
        ///  mandates.
        /// </summary>
        ...
        public class MandatePdfLinks
        {
            ...
            ///  the generated PDF. No other parameters may be provided
            ///  alongside this.
            /// </summary>
        ...
        /// <summary>
        ///  For American customers only. Subscription amount being authorised
        ///  by the mandate. In the lowest denomination for the currency (cents
        ///  in USD). Is required if `subscription_frequency` has been provided.
        /// </summary>
