...
namespace GoCardless.Services
{
    ...
    public class BillingRequestWithActionService
    {
        ...
        ///  single request.
        ///  This endpoint allows you to create a billing request and
        ///  immediately complete actions
    ...
    public class BillingRequestWithActionCreateWithActionsRequest
    {
        ...
        public class BillingRequestWithActionActions
        {
            ...
            public class BillingRequestWithActionConfirmPayerDetails
            {
                ...
                ///  payer will receive an email notification containing
                ///  instructions on how to complete the additional signature. The
                ///  dual signature flow can only be completed using GoCardless
                ///  branded pages.
                /// </summary>
            ...
            public class BillingRequestWithActionSelectInstitution
            {
                ...
                ///  alpha-2 code. The country code of the institution. If nothing
                ///  is provided, institutions with the country code 'GB' are
                ///  returned by default.
                /// </summary>
                [JsonProperty("country_code")]
                public string CountryCode { get; set; }
