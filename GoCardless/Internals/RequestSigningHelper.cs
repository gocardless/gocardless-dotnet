...
namespace GoCardless.Internals
{
    public class RequestSigningHelper
    {
        ...
        )
        {
            ...
            this.SignatureBase = GetSignatureBase(
                httpMethod,
                host,
                requestPath,
                contentDigest,
            ...
            this.GcSignatureInput = SignatureInputHeader(
                keyId,
                created,
                nonce,
                includeContentParams: contentDigest != null
            );
        }
        ...
        private string SignatureInputHeader(
            string keyId,
            string created,
            string nonce,
            bool includeContentParams
