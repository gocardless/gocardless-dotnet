...
{
  class GcStringEnumConverter : StringEnumConverter
  {
      /// <summary>
      ...
      public GcStringEnumConverter(int defaultValue)
      {
      ...
      public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
      {
          ...
          catch
          {
              ...
              if (underlyingType != null)
                  return Enum.Parse(underlyingType , $"{defaultValue}");
